          ...
          spec {
            ...
            container {
              ...
              args = [<<-EOF
                ...
                echo "Pruning backups older than ${var.backup_retention_days} days..." && \
                rclone delete --no-check-certificate --min-age ${var.backup_retention_days}d contabo:${var.contabo_bucket}/
              EOF
              ]
            }
